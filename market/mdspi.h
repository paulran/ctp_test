...
{
public:
    CMdSpi(CThostFtdcMdApi *api, const string &brokerID, const string &userID, const string &password, const vector<string> &instrumentIDs);
...
private:
    ...
    string userID_;
    string password_;
    vector<string> instrumentIDs_;
    vector<char *> ppInstrumentID_;
